...
def doc_show(
    ...
    sections_nav = [
        {"anchor": sec.anchor, "heading": sec.heading, "level": sec.level} for sec in sections_db
    ]
        ...
        sections_html = [
            {
                ...
                "row_id": sec.row_id,
                "body": sec.body or "",
                "html": render_markdown(sec.body or ""),
                "head_rev": revisions.head_for_entity(session, EntityKind.SECTION, sec.row_id)
