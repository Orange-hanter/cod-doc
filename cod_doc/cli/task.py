...
#: Оба написания каждого бакета — ключи рядом, а не вместо.
#: Легаси остаются: в ещё не мигрированной БД (до 0037) в колонке лежат они,
#: и подменить ключ значило бы уронить иконку в дефолтный глиф на старом
#: проекте вместо нового (ADO-156).
_STATUS_ICON = {
    "todo": "🟡",
    "pending": "🟡",
    "in_progress": "🔵",
...
@click.option(
    ...
    help=(
        "Filter by status. Легаси-написание и каноническое — один бакет: "
