...
#: легаси значило бы держать в живой строке написание, которого в колонке
#: уже нет: снимок эхом уходит в CLI и в `checkout_tools`, и чекаут,
#: снятый с `pending`, печатался бы как переход из статуса, которого
#: больше не существует. Управляющей логики на этой колонке нет —
#: `checkout_service.release` статус не трогает вовсе.
