...
5. Тот же цикл выполним **удалённым** ИИ-клиентом (Cursor Cloud / Claude) против облачного узла COD-DOC без монтирования диска проекта — см. [capabilities/cloud-agent-plane.md](capabilities/cloud-agent-plane.md).
