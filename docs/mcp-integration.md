...
к внешним инструментам. cod-doc реализует MCP server с **132 инструментами**
...
cod-doc-mcp --profile standard           # 128 CRUD tools (без legacy)
cod-doc-mcp --profile full               # все 132 (включая legacy)
...
|---|---|---|---|
| `com.cod-doc.mcp` | `http://127.0.0.1:8801/mcp` | `standard` | 128 |
...
| CI/CD | ✅ | ❌ | ✅ | ❌ |
| Кол-во инструментов | 132 | 132 | ~8 | 0 |
| Семантический поиск | ✅ | ✅ | ❌ | ❌ |
