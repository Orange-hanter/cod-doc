...
к внешним инструментам. cod-doc реализует MCP server с **142 инструментами**
...
cod-doc-mcp --profile standard           # 138 CRUD tools (без legacy)
...
|---|---|---|---|
| `com.cod-doc.mcp` | `http://127.0.0.1:8801/mcp` | `standard` | 138 |
...
| CI/CD | ✅ | ❌ | ✅ | ❌ |
| Кол-во инструментов | 142 | 142 | ~8 | 0 |
| Семантический поиск | ✅ | ✅ | ❌ | ❌ |
