...
харнессы сразу. Установка — `cod-doc update --install-services` (на машине без
cod-doc сначала `deploy/launchd/cod-doc-services.sh` в его репозитории — он
ставит CLI в PATH и зовёт то же самое), подробности и семантика общего сервера —
