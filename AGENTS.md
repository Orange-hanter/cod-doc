...
> `tests/services/test_agent_profile_contract.py`. 111-tool CRUD surface
...
9. **MCP server profiles** (PCA-951, cycle-4 default-switch). Запуск:
   ...
   - ``standard`` — 111 DB-backed тулов без legacy YAML.
   - ``full`` — все 115 тулов, включая legacy. Только для админ-сценариев
