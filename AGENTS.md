...
> `tests/services/test_agent_profile_contract.py`. 116-tool CRUD surface
...
9. **MCP server profiles** (PCA-951, cycle-4 default-switch). Запуск:
   ...
   - ``standard`` — 116 DB-backed тулов без legacy YAML.
   - ``full`` — все 120 тулов, включая legacy. Только для админ-сценариев
