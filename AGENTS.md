...
> `tests/services/test_agent_profile_contract.py`. 108-tool CRUD surface
...
9. **MCP server profiles** (PCA-951, cycle-4 default-switch). Запуск:
   ...
   cod-doc-mcp --profile full                 # все 112, включая legacy
   ...
   - ``standard`` — 108 DB-backed тулов без legacy YAML.
   - ``full`` — все 112 тулов, включая legacy. Только для админ-сценариев
